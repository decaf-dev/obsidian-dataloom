...
** You will also lose your previous plugin settings data. This is necessary as the plugin settings data now uses a different structure. You will NOT lose any markdown data or notes**
