...
Obsidian adds a validation layer ontop of frontmatter called properties. If you are not familiar with properties please read about them [here](https://help.obsidian.md/Editing+and+formatting/Properties).

Cell types can only accept properties of a certain type.
...
For example, a text cell can only accept a text property. When you choose a frontmatter key for a text cell, only keys that are text properties will be displayed in the dropdown menu.
