...
The examples above are not comprehensive. If you would like to full Typescript declarations for the loom file, please visit the [GitHub repository](https://github.com/trey-wallis/obsidian-dataloom/blob/master/src/shared/loom-state/types/loom-state.ts).
