...
Note: If you are not sure what to do, please open an [issue](https://github.com/decaf-dev/obsidian-dataloom/issues/new?assignees=&labels=bug&projects=&template=BUG.yml) in GitHub repository or post in the **bugs** channel of the [Discord](https://discord.gg/QaFbepMdN4) community. Paste the error details. You can get this by clicking the **Copy error details** button.
